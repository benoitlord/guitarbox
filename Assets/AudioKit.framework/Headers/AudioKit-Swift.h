...
///
/// returns:
/// The current frame while playing. It will return 0 on error.
...
///
/// returns:
/// the audioFile’s internal processingFormat
...
///
/// \endcodemidiClockFollowerMode() informs client that midi clock messages have been received
...
///
/// \endcode
+ (BOOL)renderToFile:(AVAudioFile * _Nonnull)audioFile maximumFrameCount:(AVAudioFrameCount)maximumFrameCount duration:(double)duration error:(NSError * _Nullable * _Nullable)error prerender:(void (^ _Nullable)(void))prerender progress:(void (^ _Nullable)(double))progress SWIFT_AVAILABILITY(tvos,introduced=11) SWIFT_AVAILABILITY(macos,introduced=10.13) SWIFT_AVAILABILITY(ios,introduced=11);
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL allowHapticsAndSystemSoundsDuringRecording;)
+ (BOOL)allowHapticsAndSystemSoundsDuringRecording SWIFT_WARN_UNUSED_RESULT;
+ (void)setAllowHapticsAndSystemSoundsDuringRecording:(BOOL)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL mixWithOthers;)
+ (BOOL)mixWithOthers SWIFT_WARN_UNUSED_RESULT;
+ (void)setMixWithOthers:(BOOL)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL enableEchoCancellation;)
+ (BOOL)enableEchoCancellation SWIFT_WARN_UNUSED_RESULT;
+ (void)setEnableEchoCancellation:(BOOL)value;
