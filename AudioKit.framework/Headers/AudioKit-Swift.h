...
@interface AKAppleSampler (SWIFT_EXTENSION(AudioKit))
...
@property (nonatomic) double filterEgStrength;
/// Filter resonance (dB)
@property (nonatomic) double filterResonance;
/// Amp attack time (seconds)
@property (nonatomic) double ampAttackTime;
/// Amp Decay time (seconds)
@property (nonatomic) double ampDecayTime;
/// Amp sustain level (fraction)
@property (nonatomic) double ampSustainLevel;
/// Amp Release time (seconds)
@property (nonatomic) double ampReleaseTime;
/// Filter attack time (seconds)
@property (nonatomic) double filterAttackTime;
/// Filter Decay time (seconds)
@property (nonatomic) double filterDecayTime;
/// Filter sustain level (fraction)
@property (nonatomic) double filterSustainLevel;
/// Filter Release time (seconds)
@property (nonatomic) double filterReleaseTime;
...
///
/// \param filterEgStrength same units as filterCutoff; amount filter EG adds to filterCutoff
///
/// \param filterResonance dB, -20.0 - 20.0
///
/// \param ampAttackTime seconds, 0.0 - 10.0
///
/// \param ampDecayTime seconds, 0.0 - 10.0
///
/// \param ampSustainLevel 0.0 - 1.0
///
/// \param ampReleaseTime seconds, 0.0 - 10.0
///
/// \param filterEnable true to enable per-voice filters
///
/// \param filterAttackTime seconds, 0.0 - 10.0
///
/// \param filterDecayTime seconds, 0.0 - 10.0
///
/// \param filterSustainLevel 0.0 - 1.0
///
/// \param filterReleaseTime seconds, 0.0 - 10.0
///
- (nonnull instancetype)init:(AKNode * _Nullable)input masterVolume:(double)masterVolume pitchBend:(double)pitchBend vibratoDepth:(double)vibratoDepth filterCutoff:(double)filterCutoff filterEgStrength:(double)filterEgStrength filterResonance:(double)filterResonance ampAttackTime:(double)ampAttackTime ampDecayTime:(double)ampDecayTime ampSustainLevel:(double)ampSustainLevel ampReleaseTime:(double)ampReleaseTime filterEnable:(BOOL)filterEnable filterAttackTime:(double)filterAttackTime filterDecayTime:(double)filterDecayTime filterSustainLevel:(double)filterSustainLevel filterReleaseTime:(double)filterReleaseTime OBJC_DESIGNATED_INITIALIZER;
- (void)playWithNoteNumber:(uint8_t)noteNumber velocity:(uint8_t)velocity frequency:(double)frequency;
- (void)stopWithNoteNumber:(uint8_t)noteNumber;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
